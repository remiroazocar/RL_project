...
model_dir = "../models/A5i" # directory for saving models
...
with tf.Session() as sess:
    ...
    savingpath = saver.save(sess, "../models/A5i/A5i")
    # saved model
    print('Model saved.')
    i = i+1

# save results (performance/bellman loss)
filepath = 'A5ifinalresults'
...
perf = np.load('A5ifinalresults.npy')
print("Saving plots")
...
plt.savefig('A5i_30h_performance_LR_0.02.png', bbox_inches='tight')
...
plt.savefig('A5i_30h_bellmanloss_LR_0.02.png', bbox_inches='tight')
"""