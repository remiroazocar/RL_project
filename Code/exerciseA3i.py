...
model_dir = "../models/A3i" # directory for saving models
...
# weights
w = {'L1': tf.Variable(tf.truncated_normal([4, 2], 0, stddev =0.1)/np.sqrt([4,2]).sum())}
...
def NN_hidden(currentstate):
    out = tf.matmul(currentstate, w['L1'])
    return out
...
for lr in LRS:
    ...
    w = {'L1': tf.Variable(tf.truncated_normal([4, 2], 0, stddev=1) /
         np.sqrt([4, 2]).sum())}
...
with tf.Session() as sess:
    sess.run(init)
    test = np.empty([0,1])
    print("Restoring model (best performing). Test in 100 games (max episode length is 150).")
...
perf = np.load('A3ifinalresults.npy')
...
plt.savefig('A3i_performance_LR1.png', bbox_inches='tight')
...
plt.savefig('A3i_bellmanloss_LR1.png', bbox_inches='tight')
...
plt.xlabel('episodes')
plt.ylabel('average episode length')
plt.savefig('A3i_performance_LR2.png', bbox_inches='tight')
...
plt.xlabel('episodes')
plt.ylabel('Bellman loss')
plt.savefig('A3i_bellmanloss_LR2.png', bbox_inches='tight')
...
plt.xlabel('episodes')
plt.ylabel('average episode length')
plt.savefig('A3i_performance_LR3.png', bbox_inches='tight')
...
plt.xlabel('episodes')
plt.ylabel('Bellman loss')
plt.savefig('A3i_bellmanloss_LR3.png', bbox_inches='tight')
...
plt.xlabel('episodes')
plt.ylabel('average episode length')
plt.savefig('A3i_performance_LR4.png', bbox_inches='tight')
...
plt.xlabel('episodes')
plt.ylabel('Bellman loss')
plt.savefig('A3i_bellmanloss_LR4.png', bbox_inches='tight')
...
plt.xlabel('episodes')
plt.ylabel('average episode length')
plt.savefig('A3i_performance_LR5.png', bbox_inches='tight')
...
plt.xlabel('episodes')
plt.ylabel('Bellman loss')
plt.savefig('A3i_bellmanloss_LR5.png', bbox_inches='tight')
...
plt.xlabel('episodes')
plt.ylabel('average episode length')
plt.savefig('A3i_performance_LR6.png', bbox_inches='tight')
...
plt.xlabel('episodes')
plt.ylabel('Bellman loss')
plt.savefig('A3i_bellmanloss_LR6.png', bbox_inches='tight')
"""